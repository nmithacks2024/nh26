...
const partners2 = [
    'GitHub', 'Yellow Hills AI', 'HackCulture', 'Devfolio',
    'Major League Hacking', 'theDevArmy', 'HulChul.in', 'OSCode', 'n8n', '.xyz']

const partners = [
    { name: "GitHub", logo: "/assets/GitHub.png" },
    { name: "Yellow Hills AI", logo: "/assets/yellowhillsai.png" },
    { name: "HackCulture", logo: "/assets/HackCulture.png" },
    { name: "Devfolio", logo: "/assets/Devfolio.png" },
    { name: "Major League Hacking", logo: "/assets/mlh-logo-white.png" },
    { name: "theDevArmy", logo: "/assets/devArmyLogo.png" },
    { name: "HulChul.in", logo: "/assets/HulChul cropped 2.png" },
    { name: "OSCode", logo: "/assets/OSCode Logo.png" },
    { name: "n8n", logo: "/assets/n8n_pink+white_logo.png" },
    { name: ".xyz", logo: "/assets/xyz-logo-white.png" },
]
...
const StatCard = ({ icon, number, label }) => {
    ...
    return (
        <div
            className="flex-1 lg:mr-5 bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-6 text-left bg-[#02093D] backdrop-blur-sm hover:shadow-[0_0_20px_rgba(255,0,0,0.5)] transition-all duration-300 h-full"
    ...
    return (
        <section className="w-full py-20 bg-[#010524ff] text-white relative overflow-hidden" ref={containerRef}>
            ...
            <div className="max-w-[90vw] xl:max-w-7xl mx-auto px-6 relative z-10 reveal">
                ...
                {/* Partners Marquee */}
                <div className="relative w-full overflow-hidden py-7 mb-12 border border-white/10 bg-white/5 backdrop-blur-md rounded-2xl">
                    <p className="text-center text-[11px] tracking-widest text-gray-500 uppercase mb-5 font-['PPMori']">
                        partners &amp; sponsors
                    </p>

                    {/* Fade edges */}
                    <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-[#010524] to-transparent z-10 pointer-events-none" />
                    <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-[#010524] to-transparent z-10 pointer-events-none" />
                        ...
                        {[...partners, ...partners].map((partner, i) => (
                            <div key={i} className="flex items-center px-8">
                                ...
                                <Image
                                    ...
                                    width={120}
                                    height={40}
                                    className="hover:scale-110 transition-transform h-8 w-auto object-contain opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300"
                                />

                                <span className="ml-8 w-1 h-1 rounded-full bg-[#ff0000] opacity-70 flex-shrink-0" />
                            </div>
                        ))}
                    </div>
                </div>
