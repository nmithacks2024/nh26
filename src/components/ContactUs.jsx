  ...
  return (
    <section className="min-h-screen bg-[#010524ff] text-white py-12 px-4 flex flex-col items-center justify-between relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-6 w-full z-10">
        ...
        <button className="mt-4 px-6 py-2 md:px-8 md:py-3 rounded-full border-1 border-red-500 text-white hover:bg-white hover:text-black transition-all duration-300 font-semibold text-sm md:text-base">
          Code of Conduct
        </button>
