  ...
  return (
    <section className="min-h-screen bg-black text-white py-12 px-4 flex flex-col items-center justify-between relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-6 w-full z-10">
        ...
        <button className="mt-4 px-6 py-2 md:px-8 md:py-3 rounded-full border border-white text-white hover:bg-white hover:text-black transition-all duration-300 font-semibold text-sm md:text-base">
          Code of Conduct
        </button>
...
const SocialIcon = ({ href, icon }) => {
  return (
    <a 
      ...
      className="w-12 h-12 rounded-full border-[2px] border-white flex items-center justify-center text-white hover:bg-white hover:text-black transition-all duration-300"
    >
      {icon}
    </a>
  );
